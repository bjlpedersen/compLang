error id: file://<WORKSPACE>/info/labs/lab02/src/amyc/parsing/Lexer.scala:whiteSpaces
file://<WORKSPACE>/info/labs/lab02/src/amyc/parsing/Lexer.scala
empty definition using pc, found symbol in pc: 
semanticdb not found

found definition using fallback; symbol whiteSpaces
offset: 6999
...
object AmyLexer extends Pipeline[List[File], Iterator[Token]] {
  ...
  // String literal,
  def stringLiteralRegex(): Regex[Char] = "\"".r ~ (("\\\\" .r | "\\\"".r | azAZ | digits | anyOf(" \t\r") | specialChars).*) ~ "\"".r
  // TODO
 ...
 // Delimiters,
  ...
  // Whitespaces,
  // TODO
  val whitespaceRule = Rule(regex = whiteSpac@@es.+, tag = "whitespace", isSeparator = true, transformation = WhitespaceValueInjection.injection)
        ...
        case _ if token.rule == integerLiteralRule =>
            ...
            token.value match
                case IntegerValue(text) =>
                    ...
                    if (bigVal < Int.MinValue || bigVal > Int.MaxValue) then
                        Some(Tokens.ErrorToken(s"Integer literal out of bounds: ${str}").setPos(pos))
                    else
