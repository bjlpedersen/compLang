...
non-local guesses:
	 ...
	 -amyc/utils/Rule#
	 -amyc/utils/Rule().
	 -com/ziplex/lexer/Rule.
	 -com/ziplex/lexer/Rule#
	 -com/ziplex/lexer/Rule().
	 -amyc/utils/RegexUtils.Rule.
	 -amyc/utils/RegexUtils.Rule#
	 -amyc/utils/RegexUtils.Rule().
	 -ZiplexTokens.Rule.
	 -ZiplexTokens.Rule#
...
object AmyLexer extends Pipeline[List[File], Iterator[Token]] {
  ...
  // Delimiters,
  // TODO
  val delimiterRule = Ru@@le(regex = delimiterRegex(), tag = "delimiter", isSeparator = false, transformation = DelimiterValueInjection.injection)
